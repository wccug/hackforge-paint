...
namespace hackforge {
    ...
    static constexpr float sc_dialogbox_margin = 20;
    static constexpr float sc_dialogbox_tabStop = 130;

    static constexpr int sc_default_canvas_width = 800;
    static constexpr int sc_default_canvas_height = 600;

    static constexpr int sc_minimum_canvas_width = 600;
